...
## Raster
crnt <- raster('./rf/output/run_4/results/process/rf-mixed_bsl.tif')
ftre <- raster('./rf/output/run_4/results/process/rf-mix_ftr-modal.tif')
...
plot(impg)
terra::writeRaster(x = impg, filename = './rf/output/run_4/results/process/rf-impactGradient_mdl.tif', overwrite = TRUE)
...
gmap
ggsave(plot = gmap, filename = './png/maps/clustering/v3/v3_rf_impactGradient.jpg', units = 'in', width = 7, height = 3.5, dpi = 300, create.dir = TRUE)
